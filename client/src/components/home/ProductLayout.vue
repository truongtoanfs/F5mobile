    ...
    <div class="pb-2">
        <div class="py-5 flex flex-col xl:flex-row xl:justify-between xl:items-center xl:py-1">
            <div class="flex flex-col items-center xl:flex-row">
                ...
                <router-link :to="productCategoriesLink" class="text-lg py-0.5 px-3 bg-f5-primary text-white hover:text-gray-100 rounded mt-2.5 xl:mt-0 xl:ml-4">Xem thêm</router-link>
            </div>
            <div class="hidden capitalize text-base font-medium mt-4 mb-2 md:flex md:items-center md:justify-center  xl:text-white xl:font-normal xl:uppercase">
                <router-link v-for="linkObject in productLinksList" :key="linkObject.id" :to="linkObject.seriesPath" class="px-4 xl:bg-gray-500 xl:bg-opacity-70 xl:hover:bg-opacity-100 xl:rounded-md xl:ml-1.5 xl:py-1 xl:px-2">{{ linkObject.seriesName }}</router-link>
            </div>
        </div>
